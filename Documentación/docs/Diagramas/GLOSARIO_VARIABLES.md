...
| `CTC_por_min_etapa` / `CTN_por_min_etapa` | Costo de energía de producción o configuración en período caro / normal por etapa, ambos en moneda/minuto. | `Scripts/simulacion.py`. |
...
| `CTEConfiguracion` | Costo energético acumulado durante cambios de configuración, en moneda. | `Scripts/simulacion.py`, `Resultados.mermaid`. |
| `CMO_configuracion_por_min_etapa` | Costo de mano de obra por minuto de configuración en cada etapa, en moneda/minuto. QA usa cero. | `Scripts/config/caso_base.json`, `Scripts/simulacion.py`. |
| `CostoManoObraConfiguracion` | Mano de obra acumulada durante los minutos activos de configuración, en moneda. | `Scripts/simulacion.py`, `Resultados.mermaid`. |
| `CostoConfiguracion` | Suma de energía y mano de obra de configuración, en moneda. | `Scripts/simulacion.py`. |
