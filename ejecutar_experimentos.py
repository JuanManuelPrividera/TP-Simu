...
guardan en ``resultados/<conjunto>.json`` y los gráficos en
``graficos/<conjunto>/``. No requiere dependencias de Python externas.
"""
...
def main() -> None:
    ...
    parser.add_argument("--graficos", type=Path, default=RAIZ / "graficos", help="Carpeta de gráficos de salida.")
    ...
    for nombre in nombres:
        ...
        comando_simulacion = [
            sys.executable, str(RAIZ / "docs" / "simulacion.py"), str(archivo_casos),
