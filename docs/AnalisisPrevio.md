...
| Datos | IA (Intervalo arrivo), PCP (Prob Cant Páginas), CUL (Cant, Unidades de Libros a Imprimir), PD (Prob Defectos), TEF\[5\] (Tiempo entre fallas de cada máquina), TDR\[5\] (Tiempo de Reparación de cada máquina), TMM\[5\] (Tiempo de mantenimiento por máquina), CEM\[5\] (Consumo Energético de cada tipo de Máquina), TPM\[5\] (Tiempo de configuración por maquina), TR\[5\] (Tiempo de reposición) |
...
| Reposición\[n\] | \- | Reposición\[n\] | SD\[n\] \<= SPR\[n\] |