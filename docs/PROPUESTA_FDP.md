...
| `DI` | `Triangular(0.95*base, base, 1.05*base)` con `base = paginas/80` min | La duración depende del volumen del lote y de un throughput nominal publicado. La triangular preserva el valor central y acota extremos. | Base local en [docs/Diagramas/FDPs/DI.mermaid](/home/asmot/DATA/_universidad/5to_anio/simu_tp/TP-Simu/docs/Diagramas/FDPs/DI.mermaid), [BQ-300 PDF](https://www.horizon.co.jp/products/catalog/e_pdf/e002bi/01bq1_pdf/BQ300_e.pdf) y [Xerox Versant 280 PDF](https://download.support.xerox.com/pub/docs/VERSANT_280/userdocs/any-os/en_GB/Xerox_Versant_280_press_ug_en-US.pdf). |
...
| `AQA` | Mantener `Bernoulli(p=0.025)` | Es la FDP correcta para aceptación/rechazo por lote. No se recomienda cambiarla sin nuevos datos de QA. | [docs/Diagramas/FDPs/AQA.mermaid](/home/asmot/DATA/_universidad/5to_anio/simu_tp/TP-Simu/docs/Diagramas/FDPs/AQA.mermaid), DOI citado allí: `https://doi.org/10.71456/sur.v4i2.1713`. |
| `TConf` | `Triangular(0.5, 0.75, 1.0)` min | El proveedor documenta cambios de trabajo en el orden de 30 a 60 segundos; la triangular es adecuada para un tiempo acotado con centro en 45 s. | [docs/Diagramas/FDPs/TConf.mermaid](/home/asmot/DATA/_universidad/5to_anio/simu_tp/TP-Simu/docs/Diagramas/FDPs/TConf.mermaid), [Xerox Versant 280 PDF](https://download.support.xerox.com/pub/docs/VERSANT_280/userdocs/any-os/en_GB/Xerox_Versant_280_press_ug_en-US.pdf). |
| `ID` | `Exponencial(mean=2104.8 min)` | Para tiempo entre fallas, la hipótesis estándar es una tasa de falla constante. Eso conduce a una exponencial con MTBF igual a la media publicada. | [docs/Diagramas/FDPs/ID.mermaid](/home/asmot/DATA/_universidad/5to_anio/simu_tp/TP-Simu/docs/Diagramas/FDPs/ID.mermaid), artículo citado allí sobre MTBF de Heidelberg SM 102 ZP. |
...
| `IM` | `Triangular(1451.4, 1511.4, 1571.4)` min | El intervalo de mantenimiento es programado y tiene un centro claro alrededor de 25.19 h. Triangular captura ese comportamiento con soporte finito. | [docs/Diagramas/FDPs/IM.mermaid](/home/asmot/DATA/_universidad/5to_anio/simu_tp/TP-Simu/docs/Diagramas/FDPs/IM.mermaid), artículo citado allí sobre Manroland 508. |
...
- Las variables de mantenimiento (`ID`, `DD`, `IM`, `DM`) quedan mejor representadas con distribuciones acotadas o exponenciales según el rol operativo.
- `PaginasLibro` y `AQA` ya son consistentes con el objetivo del modelo y no requieren cambios urgentes.
...
- Artículos y reportes citados dentro de los archivos `docs/Diagramas/FDPs/ID.mermaid`, `DD.mermaid`, `IM.mermaid` y `DM.mermaid`
